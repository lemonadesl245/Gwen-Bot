...
app.get('/', (req, res) => {
  res.send('Gwen has Working in\'s  <a href="https://discord.gg/D698QK39Au">Brainless Kingdom</a>')
})
...
axios.get('https://api.github.com/repos/CorwinDev/Discord-Bot/releases/latest').then(res => {
  if (res.data.tag_name !== version) {
    console.log(chalk.red.bgGreen(`Everything it good to run`, version + ' -> ' + res.data.tag_name));
  }
}).catch(err => {
...
console.log(`\u001b[0m`)
console.log(chalk.red(`Siro Lemon | 2021 - ${new Date().getFullYear()}`))
